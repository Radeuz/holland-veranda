...
export default function Home() {
  ...
  const testimonials = [
    ...
    {
      text: "We hebben schuifpuien en rolluiken laten installeren door Holland Veranda. Alles verliep snel en professioneel. Een echte aanrader!",
      firstName: "Peter",
      lastName: "Bakker",
      location: "Antwerpen",
      initial: "P"
        ...
        <div className="relative container mx-auto px-4 h-[600px]">
          <div className="flex flex-col md:flex-row h-full items-center w-full">
            ...
            <div className="text-center md:text-left md:w-1/2 z-20">
              <h1 className="text-[2.4rem] md:text-[3.5rem] lg:text-[4rem] font-bold mb-6 text-white whitespace-nowrap">
                Holland Veranda
              </h1>
      ...
      <section className="py-12 relative bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-white">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="relative bg-white/5 backdrop-blur-md p-5 rounded-lg overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  <div className="relative">
                    <div className="bg-gradient-to-r from-white/10 to-white/5 p-4 rounded-lg border border-white/10">
                      <svg className="h-5 w-5 text-orange-500 mb-2 opacity-50" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                      </svg>
                      <p className="text-gray-200 italic mb-3 leading-relaxed text-base min-h-[80px]">"{testimonials[currentTestimonial].text}"</p>
                      <div className="flex items-center">
                        <div className={`h-8 w-8 rounded-full ${getAvatarColor(testimonials[currentTestimonial].initial)} flex items-center justify-center mr-2`}>
                ...
                <div className="mt-4">
                  <a 
                    ...
                    className="group flex items-center justify-center text-white bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-600 px-4 py-2 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-orange-500/20 text-base"
                  >
