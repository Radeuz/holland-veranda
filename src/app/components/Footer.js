        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-gray-300">info@hollandveranda.nl</p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-gray-300">Maandag - Vrijdag: 9:00 - 17:00</p>
              <p className="text-gray-300">Zaterdag: 10:00 - 15:00</p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link href="/over-ons" className="text-gray-300 hover:text-white transition-colors block">Over Ons</Link>
              <Link href="/producten" className="text-gray-300 hover:text-white transition-colors block">Producten</Link>
              <Link href="/projecten" className="text-gray-300 hover:text-white transition-colors block">Projecten</Link>
