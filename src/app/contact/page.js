...
export default function Contact() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50/30 to-gray-50">
      ...
      {/* Page Header */}
      <div className="relative bg-gradient-to-r from-orange-600 via-orange-500 to-orange-400 pt-12 pb-8">
              ...
              <div className="bg-gradient-to-br from-orange-600 via-orange-400 to-orange-100 rounded-xl shadow-lg p-8">
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-orange-900 font-medium">
                      Tel: <a href="https://wa.me/31618612190" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors underline">+31 (0) 618 612 190</a><br />
