        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {products.map((product) => (
              <div key={product.id} className="bg-gradient-to-br from-gray-50 via-orange-50/50 to-gray-50 rounded-lg overflow-hidden shadow-lg transition-transform hover:scale-[1.02] flex flex-col">
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="mb-4">
                    <h4 className="font-semibold text-gray-700 mb-2">{t('products.features')}</h4>
